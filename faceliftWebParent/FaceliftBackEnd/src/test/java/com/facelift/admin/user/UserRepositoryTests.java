...
public class UserRepositoryTests {
	...
	public void testCreateNewUserWithOneRole() {
		...
		User userNamHM = new User("facelift.ke@gmail.com", "admin@", "Shirley", "Shirley");
...
//		user.email("noel@gmail.com");
		...
		user.setEmail("facelift.ke@gmail.com");
		user.setPassword("admin");
		user.setFirstName("Shirley");
		user.setLastName("Ndunge");
		user.setEnabled(true);
		Role userRoles = new Role("Admin", "Manage Everything");
		Role role1= new Role();
		role1.setId(2);
		role1.setName("Admin");
		role1.setDescription("admin role");
		userRoles.setId(1);
		userRoles.setDescription("Admin Role");
